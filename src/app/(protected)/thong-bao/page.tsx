          ...
          <div className="divide-y divide-silver/10">
            {notifications.map((n) => {
              ...
              return (
                <div
                  key={n.id}
                  onClick={() => { if (clickable) router.push(n.link); }}
                  className={`px-5 py-4 ${n.isRead ? "" : "bg-gold/5"} ${clickable ? "cursor-pointer transition-colors hover:bg-cream/50" : ""}`}
                >
                  ...
                  <div className="mt-1 flex items-center justify-between">
                    ...
                    {clickable && (
                      <span className="inline-flex items-center gap-0.5 text-[0.7rem] font-semibold text-gold">
